...
CVIBufferCube::CVIBufferCube(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
...
HRESULT CVIBufferCube::InitializePrototype()
{
...
HRESULT CVIBufferCube::Initialize(void * pArg)
{
	return S_OK;
}

CVIBufferCube * CVIBufferCube::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CVIBufferCube*			pInstance = new CVIBufferCube(pDevice, pContext);

	if (FAILED(pInstance->InitializePrototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CVIBufferCube"));
...
CComponent * CVIBufferCube::Clone(void * pArg)
{
	...
	{
		MSG_BOX(TEXT("Failed To Cloned : CVIBufferCube"));
		SafeRelease(pInstance);
	}
