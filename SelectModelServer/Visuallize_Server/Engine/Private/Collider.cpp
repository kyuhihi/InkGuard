...
HRESULT CCollider::InitializePrototype(TYPE eColliderType)
{
...
HRESULT CCollider::Render()
{
	...
	m_pEffect->SetView(pPipeLine->GetTransformMatrix(CPipeLine::D3DTS_VIEW));
	m_pEffect->SetProjection(pPipeLine->GetTransformMatrix(CPipeLine::D3DTS_PROJ));
...
_matrix CCollider::RemoveRotation(_fmatrix Matrix)
{
