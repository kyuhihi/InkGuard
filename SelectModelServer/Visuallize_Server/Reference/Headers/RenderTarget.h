...
public:
	...
	HRESULT Clear();
	HRESULT BindSRV(class CShader* pShader, const char* pConstantName);
#ifdef _DEBUG
public:
	HRESULT InitializeDebug(_float fX, _float fY, _float fSizeX, _float fSizeY);
#endif // _DEBUG

#ifdef _DEBUG
public:
	HRESULT RenderDebug(class CShader* pShader, class CVIBuffer* pVIBuffer);
#endif // _DEBUG
