...
public:
	using COLLIDERDESC = struct tagColliderDesc
	{
		_float3 vCenter;
		_float3 vSize;
		_float3 vRotation;
...
public:
	TYPE GetColliderType() const {
		return m_eColliderType;
	}

public:
	virtual HRESULT InitializePrototype(TYPE eColliderType);
...
protected:
	_matrix RemoveRotation(_fmatrix Matrix);
