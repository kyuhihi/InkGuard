                     ...
                     _In_ int       nCmdShow)
{
	...
	if (FAILED(pGameInstance->AddTimer(TEXT("Timer_Default"))))
		return FALSE;
	if (FAILED(pGameInstance->AddTimer(TEXT("Timer_60"))))
		return FALSE;
...
{
	if (CImGuiManager::ImGuiImplWin32WndProcHandler(hWnd, message, wParam, lParam))
		return true;
